                     ...
                     SerialDataReceivedEventArgs e)
        {
            ...
            if (indata.Contains("HIT"))
            {
                while (sp.BytesToRead != 8)
                {
                    ...
                    if (tok.Length == 3)
                    {
                        double.TryParse(tok[1], out this.hitLocation[0]);
                        double.TryParse(tok[2], out this.hitLocation[1]);
                        hitCount++;
                    }
                    if (targetHit != null)
                    {
                ...
                //Should raise the Target.targetHit event that you can put into the game
